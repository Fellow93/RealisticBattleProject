...
namespace RealisticBattle
{
    ...
    //            //skirmishersLeft.AI.SetBehaviorWeight<BehaviorProtectFlank>(1f).FlankSide = FormationAI.BehaviorSide.Left;
    //            skirmishersLeft.AI.SetBehaviorWeight<BehaviorFlank>(1f);
    //            //skirmishersLeft.AI.SetBehaviorWeight<BehaviorSkirmishBehindFormation>(1f).ReferenceFormation = skirmishersLeft.QuerySystem.ClosestSignificantlyLargeEnemyFormation.Formation;
    //        }
    //        if (skirmishersRight != null)
    //        {
    //            skirmishersRight.AI.ResetBehaviorWeights();
    //            SetDefaultBehaviorWeights(skirmishersRight);
    //            //skirmishersRight.AI.SetBehaviorWeight<BehaviorProtectFlank>(1f).FlankSide = FormationAI.BehaviorSide.Right;
    //            skirmishersRight.AI.SetBehaviorWeight<BehaviorFlank>(1f);
    //            //skirmishersRight.AI.SetBehaviorWeight<BehaviorSkirmishBehindFormation>(1f).ReferenceFormation = skirmishersLeft.QuerySystem.ClosestSignificantlyLargeEnemyFormation.Formation;
    //        }
    //        if (cavalryLeft != null)
    //        {
    ...
    //        {
    //            return meleeInfantry.QuerySystem.MedianPosition.AsVec2.Distance(meleeInfantry.QuerySystem.ClosestEnemyFormation.MedianPosition.AsVec2) / meleeInfantry.QuerySystem.ClosestEnemyFormation.MovementSpeedMaximum <= 5f + (_hasBattleBeenJoined ? 5f : 0f);
    //        }
    //        return true;
    //    }
