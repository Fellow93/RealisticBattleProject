    ...
    public static class TradeGoodValues
    {
        ...
        private static readonly Dictionary<string, (int value, float weight)> Table =
            new Dictionary<string, (int, float)>
            {
                ...
                { "cotton",      (1925,   1f) },
                { "flax",        (34,     1f) },
                { "clay",        (130,    10f) }, //clay here represents regular pottery, actual clay = { "clay",        (26,     13f) },
                { "pottery",     (900,    10f) }, //pottery here represents expensive majolica pottery, actual pottery = { "pottery",     (130,    10f) },
                { "linen",       (170,    0.76f) },
                { "leather",     (176,    0.8f) },
                { "velvet",      (26500,  0.5f) },
                { "cheese",      (166,    15f) },
