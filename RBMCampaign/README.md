...
*The cavalry charge, and charge again.* Weight and speed are not a thing a rider has for the whole battle or spends in one shock: he comes in at the gallop, kills, is hemmed in, backs out and comes round again. So a **share of his blows** carry the horse behind them and the rest are a man swinging a sword from a saddle — a coin thrown at every stroke, for as long as the fight lasts. How weighted the coin is depends on the ground, the same ground the horse archer needs to ride away on: on the open steppe half his blows land at the charge, in a wood far fewer, and hemmed into a village street or up against a wall none at all. And a footman hacking upward at a rider is mostly hacking at the **horse**. Horses die; when one does, its rider loses the barding that was answering those blows, and they start finding his head instead of his legs.
