...
Three figures in all this are judgement rather than measurement, and are exposed so you can argue with them: how much of a blow a shield turns aside, how much of a soldier's damage his training accounts for under vanilla rules, and how the blows distribute across a man's body. Everything else is read from the game's own equations and item data, or measured from its own troop roster.
