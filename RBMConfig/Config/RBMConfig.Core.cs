...
namespace RBMConfig
{
    public static partial class RBMConfig
    {
        ...
        public static void parseXmlConfig()
        {
            ...
            constructionBudgetShare = float.Parse(ReadOrCreate("/Config/RBMCampaign", "ConstructionBudgetShare", "0.01"), CultureInfo.InvariantCulture);
            ...
            settlementPatrolsEnabled = ReadOrCreate("/Config/RBMCampaign", "SettlementPatrolsEnabled", "1").Equals("1");
            patrolBudgetFraction = float.Parse(ReadOrCreate("/Config/RBMCampaign", "PatrolBudgetFraction", "0.02"), CultureInfo.InvariantCulture);
        ...
        public static void saveXmlConfig()
        {
            ...
            setInnerText(xmlConfig.SelectSingleNode("/Config/RBMCampaign/ConstructionBudgetShare"), constructionBudgetShare.ToString(CultureInfo.InvariantCulture));
            ...
            setInnerText(xmlConfig.SelectSingleNode("/Config/RBMCampaign/WorkshopProductionMultiplier"), workshopProductionMultiplier.ToString(CultureInfo.InvariantCulture));
            ...
            setInnerTextBoolean(xmlConfig.SelectSingleNode("/Config/RBMCampaign/SettlementPatrolsEnabled"), settlementPatrolsEnabled);
            setInnerText(xmlConfig.SelectSingleNode("/Config/RBMCampaign/PatrolBudgetFraction"), patrolBudgetFraction.ToString(CultureInfo.InvariantCulture));
