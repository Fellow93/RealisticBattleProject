...
namespace RBMAI
{
    ...
    public static class PostureDamage
    {
        ...
        public const float ONEHANDEDAXE_SWING_DRAIN = 30f;
        public const float ONEHANDEDAXE_THRUST_DRAIN = 25f;
        public const float ONEHANDEDAXE_OVERHEAD_DRAIN = 35f;
        ...
        public const float TWOHANDEDAXE_OVERHEAD_COST = 21f;
        public const float TWOHANDEDAXE_SWING_DRAIN = 40f;
        public const float TWOHANDEDAXE_THRUST_DRAIN = 40f;
        public const float TWOHANDEDAXE_OVERHEAD_DRAIN = 50f;
        public const float TWOHANDEDAXE_BLOCK_COST = 2f;
        public const float TWOHANDEDAXE_PARRY_COST = -5f;
        public const float TWOHANDEDAXE_HIT_COST = 15f;
        public const float TWOHANDEDAXE_BLOCK_REFLECT = 0f;
        public const float TWOHANDEDAXE_PARRY_REFLECT = 40f;

        public const float MACE_SWING_COST = 15f;
        public const float MACE_THRUST_COST = 13f;
        public const float MACE_OVERHEAD_COST = 18f;
        ...
        public const float MACE_BLOCK_COST = 8f;
        ...
        public const float TWOHANDEDMACE_SWING_COST = 20f;
        public const float TWOHANDEDMACE_THRUST_COST = 18f;
        public const float TWOHANDEDMACE_OVERHEAD_COST = 23f;
        public const float TWOHANDEDMACE_SWING_DRAIN = 60f;
        public const float TWOHANDEDMACE_THRUST_DRAIN = 50f;
        public const float TWOHANDEDMACE_OVERHEAD_DRAIN = 70f;
        public const float TWOHANDEDMACE_BLOCK_COST = 5f;
        public const float TWOHANDEDMACE_PARRY_COST = 0f;
        public const float TWOHANDEDMACE_HIT_COST = 15f;
        public const float TWOHANDEDMACE_BLOCK_REFLECT = 0f;
        public const float TWOHANDEDMACE_PARRY_REFLECT = 20f;

        public const float ONEHANDEDPOLEARM_SWING_COST = 18f;
        public const float ONEHANDEDPOLEARM_THRUST_COST = 12f;
        public const float ONEHANDEDPOLEARM_OVERHEAD_COST = 21f;
        public const float ONEHANDEDPOLEARM_SWING_DRAIN = 20f;
        public const float ONEHANDEDPOLEARM_THRUST_DRAIN = 20f;
        public const float ONEHANDEDPOLEARM_OVERHEAD_DRAIN = 25f;
        ...
        public const float TWOHANDEDPOLEARM_SWING_COST = 17f;
        ...
        public const float TWOHANDEDPOLEARM_BLOCK_REFLECT = 0f;
        public const float TWOHANDEDPOLEARM_PARRY_REFLECT = 5f;
